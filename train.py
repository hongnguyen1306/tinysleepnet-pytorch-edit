...
def train(
    ...
    train_files = []
    train_files = glob.glob(os.path.join("/content/drive/MyDrive/Thesis/Tinysleepnet-pytorch/data/physionet_sleep/train", "*.npz"))
    train_files = np.hstack(train_files)
    train_x, train_y, _ = load_data(train_files)

    val_files = []
    val_files = glob.glob(os.path.join("/content/drive/MyDrive/Thesis/Tinysleepnet-pytorch/data/physionet_sleep/val", "*.npz"))
    ...
    test_files = []
    test_files = glob.glob(os.path.join("/content/drive/MyDrive/Thesis/Tinysleepnet-pytorch/data/physionet_sleep/test", "*.npz"))
